...
func TestDropUpdate_unauthorized(t *testing.T) {
	//ts := initApp()
	//defer ts.Close()
	//registerUser(t, ts)
	//
	...
	//}
	//
	//req, err := http.NewRequest(http.MethodPost, ts.URL+"/api/v1/drop/update", bytes.NewReader(bodyBytes))
	//if err != nil {
...
func TestDropUpdate_dropNotFound(t *testing.T) {
	//ts := initApp()
	//defer ts.Close()
	//registerUser(t, ts)
	//
...
func TestDropUpdate_ok(t *testing.T) {
	//ts := initApp()
	//defer ts.Close()
	//registerUser(t, ts)
	//
